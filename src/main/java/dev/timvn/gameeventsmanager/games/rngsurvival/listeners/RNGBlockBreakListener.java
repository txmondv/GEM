...
public class RNGBlockBreakListener implements Listener {
    ...
    private void onBlockBreak(BlockBreakEvent event) {
        ...
        if(!RNGGameManager.startRollingActions) {
            return;
        }
                ...
                Bukkit.getScheduler().scheduleSyncDelayedTask(plugin, () -> {
                    switch (MineEventRolledNumber) {
                        ...
                        case 12, 13, 14:
                            ...
                            worldtoSpawnIn.spawnEntity(locToSpawnAt, EntityType.ALLAY, true);
                        ...
                        case 6, 7, 8:
                            ...
                            p.getWorld().spawnEntity(event.getBlock().getLocation(), EntityType.ENDERMITE);
                        ...
                        case 3, 4, 5:
                            ...
                            BukkitTask task = new BukkitRunnable() {
                                public void run() {
                                    ...
                                    worldtoSpawnIn1.spawnEntity(locToSpawnAt1, EntityType.SILVERFISH);
                                    timesRolled[0]++;
                                }
                        ...
                        case 1:
                            ...
                            TNTPrimed tnt = p.getWorld().spawn(targetBlock.getLocation().add(0, 0, 0), TNTPrimed.class);
                            TNTPrimed tnt1 = p.getWorld().spawn(targetBlock.getLocation().add(1, 0, 0), TNTPrimed.class);
                            TNTPrimed tnt2 = p.getWorld().spawn(targetBlock.getLocation().add(0, 0, 1), TNTPrimed.class);

                            tnt.setFuseTicks(10);
                            tnt1.setFuseTicks(10);
